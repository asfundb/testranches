...
document.addEventListener("DOMContentLoaded", function () {  
  // JavaScript for Mobile Accordions
  // document.addEventListener("DOMContentLoaded", function () {
  var acc = document.getElementsByClassName("footer-block__title");
  ...
  function initAccordion() {
    if (window.innerWidth <= 768) {
      ...
      for (var i = 0; i < acc.length; i++) {
        ...
        // Reset any max-height set when the accordion was active
        if (acc[i].classList.contains("active")) {
          acc[i].classList.remove("active");
          acc[i].parentNode.nextElementSibling.style.maxHeight = null;
        }
      }
    }
  }

  // Call initAccordion function on load and resize
  initAccordion();
...
document.addEventListener("DOMContentLoaded", function () {
  var sliders = document.querySelectorAll(".prevent-wheel");

  sliders.forEach(function (slider) {
    // Attach wheel event listener to prevent default horizontal scrolling
    ...
    slider.addEventListener('mousemove', (e) => {
        ...
        const walk = (x - startX) * 2; // Adjust this for desired scroll speed
...
if (window.innerWidth <= 768) {
  // Get all the footer block titles
  ...
  footerTitles.forEach(function (title) {
    title.addEventListener("click", function () {
      ...
      // Get the next sibling element (the list)
...
// var reviewTab = document.querySelector(".is-review-tab");

// reviewTab.addEventListener("toggle", function (event) {
//   var reviews = document.getElementById("judgeme_product_reviews");
//   var gliderTrack = document.querySelector(".jdgm-glider-track");
//   var eachRev = document.querySelector(".jdgm-rev ");
//   if (reviewTab.hasAttribute("open")) {
//     reviews.style.display = "block";
//     gliderTrack.style.width = "700px";
//     eachRev.style.width = "700px";
...
// // // Select the element with the ID "CRIPPLE CREEK"
// var element = document.getElementsByClassName("Sh*t");

// if (element) {
//   element[0].style.paddingTop = "69px";
// } else {
//   console.log('Element with ID "CREEK" not found.');
// }
...
const observer = new MutationObserver((mutations) => {
  const bundleButton = document.querySelector('._footer_1014k_125');
  if (bundleButton && !bundleButton.querySelector('p')) {
    const returnsPolicy = document.createElement('p');
    returnsPolicy.style.textAlign = 'center';
    returnsPolicy.style.margin = '0';
    returnsPolicy.style.padding = '0';
    returnsPolicy.style.fontSize = '14px';

    // Create and style the link
    const link = document.createElement('a');
    link.href = 'https://weiswesternwear.com/policies/refund-policy';
    link.style.textDecoration = 'none';
    
    // Create spans for different colored text
    const daysSpan = document.createElement('span');
    daysSpan.textContent = '30 Day ';
    daysSpan.style.color = 'black';
    
    const policySpan = document.createElement('span');
    policySpan.textContent = 'Return Policy';
    policySpan.style.color = 'blue';
    
    // Add both spans to the link
    link.appendChild(daysSpan);
    link.appendChild(policySpan);
    
    // Add the link inside the paragraph
    returnsPolicy.appendChild(link);
    bundleButton.appendChild(returnsPolicy);
  }
});
